defmodule DayOne do
  ...
  def run, do: calculate_three(@input, 0)
  ...
  def calculate_three([_el | []], index) do
    new_index = index + 1

    Enum.split(@input, new_index)
    |> elem(1)
    |> calculate_three(new_index)
  end

  def calculate_three([a | [b | tail]], index) do
    case Enum.reject(tail, fn c -> a + b + c != 2020 end) do
      [] -> calculate_three([a | tail], index)
      [c] -> a * b * c |> IO.inspect()
    end
  end
end
